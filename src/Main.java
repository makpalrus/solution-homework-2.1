...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Protection Proxy ---");
        Image protectedImage = new ProtectionProxyImage("villa.jpg", false);
        protectedImage.displayThumbnail();
        protectedImage.displayFullImage();

        Image authorizedImage = new ProtectionProxyImage("villa.jpg", true);
        ...
        System.out.println("Total marker types created: " + MarkerFactory.markers.size()); // Выведет количество уникальных стилей
    }
}
